 ...
 * grade back to the LMS gradebook via AGS, a button that fetches the course
 * roster via NRPS, and a live LTI Platform Storage round-trip proving the
 * session survives third-party-cookie blocking.
 */
